...
{
    public class vw_team_away_weekly_scheduleMap : EntityTypeConfiguration<vw_team_away_weekly_schedule>
    {
        public vw_team_away_weekly_scheduleMap()
        {
            // Primary Key
            ...
            this.ToTable("vw_team_away_weekly_schedule");
